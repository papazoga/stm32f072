...
void __attribute__((weak, alias("_default_handler"))) _DMA_CH2_3_handler();
void __attribute__((weak, alias("_default_handler"))) _DMA2_CH1_2_handler();
void __attribute__((weak, alias("_default_handler"))) _DMA_CH4_5_6_7_handler();
void __attribute__((weak, alias("_default_handler"))) _DMA2_CH3_4_5_handler();
